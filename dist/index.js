    ...
    async handle(handlerInput) {
        try {
            ...
            if (stopInfo) {
                ...
                let text = await main(Number(stopInfo)); // Assuming stopInfo is a number
...
const CheckAnyStopIntentHandler = {
    canHandle(handlerInput) {
        const request = handlerInput.requestEnvelope.request;
        return request.type === 'IntentRequest'
...
const CheckMyStopIntentHandler = {
    canHandle(handlerInput) {
        const request = handlerInput.requestEnvelope.request;
        return request.type === 'IntentRequest'
...
export const handler = SkillBuilders.custom()
    .addRequestHandlers(LaunchRequestHandler, AskWeatherIntentHandler, HelpIntentHandler, CancelAndStopIntentHandler, SessionEndedRequestHandler, AddStopIntentHandler, CheckStopIntentHandler, CheckAnyStopIntentHandler, CheckMyStopIntentHandler)
    .addErrorHandlers(ErrorHandler)
    .lambda();
